 ...
 */
final class Version20240401063627 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE contract (id UUID NOT NULL, number VARCHAR(255) NOT NULL, start_date TIMESTAMP(0) WITH TIME ZONE NOT NULL, finish_date TIMESTAMP(0) WITH TIME ZONE NOT NULL, status SMALLINT NOT NULL, created_at TIMESTAMP(0) WITH TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITH TIME ZONE NOT NULL, tariff_id UUID DEFAULT NULL, musician_id UUID DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX contract__status__ix ON contract (status)');
        $this->addSql('CREATE INDEX contract__tariff_id__ix ON contract (tariff_id)');
        $this->addSql('CREATE INDEX contract__musician_id__ix ON contract (musician_id)');
        $this->addSql('CREATE UNIQUE INDEX contract__number__ux ON contract (number)');
        ...
        $this->addSql('CREATE TABLE musician (id UUID NOT NULL, last_name VARCHAR(250) NOT NULL, first_name VARCHAR(250) NOT NULL, patronymic VARCHAR(250) NOT NULL, status SMALLINT NOT NULL, degree SMALLINT NOT NULL, phone VARCHAR(11) NOT NULL, email VARCHAR(250) NOT NULL, telegram VARCHAR(200) NOT NULL, instagram VARCHAR(200) DEFAULT NULL, facebook VARCHAR(200) DEFAULT NULL, vk VARCHAR(200) DEFAULT NULL, created_at TIMESTAMP(0) WITH TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITH TIME ZONE NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX musician__status__ix ON musician (status)');
        $this->addSql('CREATE INDEX musician__degree__ix ON musician (degree)');
        $this->addSql('CREATE UNIQUE INDEX musician__phone__ux ON musician (phone)');
        $this->addSql('CREATE UNIQUE INDEX musician__email__ux ON musician (email)');
        $this->addSql('CREATE UNIQUE INDEX musician__telegram__ux ON musician (telegram)');
        $this->addSql('CREATE UNIQUE INDEX musician__instagram__ux ON musician (instagram)');
        $this->addSql('CREATE UNIQUE INDEX musician__facebook__ux ON musician (facebook)');
        $this->addSql('CREATE UNIQUE INDEX musician__vk__ux ON musician (vk)');
        ...
        $this->addSql('CREATE TABLE tariff (id UUID NOT NULL, musician_degree_tariff SMALLINT NOT NULL, type SMALLINT NOT NULL, value NUMERIC(8, 2) NOT NULL, start_date TIMESTAMP(0) WITH TIME ZONE NOT NULL, finish_date TIMESTAMP(0) WITH TIME ZONE NOT NULL, status SMALLINT NOT NULL, created_at TIMESTAMP(0) WITH TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITH TIME ZONE NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX musician__musician_degree_tariff__ix ON tariff (musician_degree_tariff)');
        $this->addSql('CREATE INDEX musician__type__ix ON tariff (type)');
        ...
        $this->addSql('COMMENT ON COLUMN tariff.value IS \'Номинал тарифа, сколько денег возьмём\'');
        ...
        $this->addSql('ALTER TABLE contract ADD CONSTRAINT FK_E98F285992348FD2 FOREIGN KEY (tariff_id) REFERENCES tariff (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE contract ADD CONSTRAINT FK_E98F28599523AA8A FOREIGN KEY (musician_id) REFERENCES musician (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE contract DROP CONSTRAINT FK_E98F285992348FD2');
        $this->addSql('ALTER TABLE contract DROP CONSTRAINT FK_E98F28599523AA8A');
